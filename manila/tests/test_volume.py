...
class VolumeTestCase(test.TestCase):
    ...
    def test_create_volume_with_invalid_metadata(self):
        ...
        volume_api = manila.volume.api.API()
    ...
    def test_create_volume_from_oversized_image(self):
        ...
        volume_api = manila.volume.api.API(image_service=_FakeImageService())
...
class VolumeDriverTestCase(DriverTestCase):
    ...
    driver_name = "manila.volume.drivers.lvm.LVMVolumeDriver"
...
class ISCSITestCase(DriverTestCase):
    ...
    driver_name = "manila.volume.drivers.lvm.LVMISCSIDriver"
...
class FibreChannelTestCase(DriverTestCase):
    ...
    driver_name = "manila.volume.driver.FibreChannelDriver"
...
class VolumePolicyTestCase(test.TestCase):
    ...
    def _set_rules(self, rules):
        manila.common.policy.set_brain(manila.common.policy.HttpBrain(rules))

    def test_check_policy(self):
        self.mox.StubOutWithMock(manila.policy, 'enforce')
        target = {
            'project_id': self.context.project_id,
            'user_id': self.context.user_id,
        }
        manila.policy.enforce(self.context, 'volume:attach', target)
        self.mox.ReplayAll()
    ...
    def test_check_policy_with_target(self):
        ...
        manila.policy.enforce(self.context, 'volume:attach', target)
        self.mox.ReplayAll()
        manila.volume.api.check_policy(self.context, 'attach', {'id': 2})
